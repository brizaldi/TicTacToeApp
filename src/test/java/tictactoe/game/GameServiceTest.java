...
class GameServiceTest {
    ...
    void create_PlayerGoFirst_Player1TypeHuman() {
        ...
        Game game = service.create(appUser, playerGoFirst, numberOfRows);
        ...
        assertThat(game.getRows()).isEqualTo(BoardUtil.createEmpty(numberOfRows));
    ...
    void takeTurn_NewGameTwoMoves_GameInProgress() {
        Game game = service.create(new AppUser(), true, 3);
