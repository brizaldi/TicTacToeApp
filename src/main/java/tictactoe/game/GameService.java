...
public class GameService {
    ...
    @Transactional
    public Game create(AppUser appUser, boolean playerGoFirst, int numberOfRows) {
        ...
        game.setRows(BoardUtil.createEmpty(numberOfRows));
    ...
    public void takeTurn(Game game, String tileId) {
        ...
        GameState state = evaluateGameState(game.getNumberOfRows(), game.getRows());
        game.setState(state);
    ...
    private GameState evaluateGameState(int numberOfRows, List<List<String>> rows) {
        for (List<String> line : BoardUtil.getAllLines(numberOfRows, rows)) {
